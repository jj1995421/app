...
<!--                                  <li><a href="#">使用指南</a></li>
        ...
        <div class="wrapper_boxrig" style="margin-left:1%;">
            <p class="tit"><a href="" target="_blank">首页</a> 》 <a href="" target="_blank">家庭宽带</a> 》 <a href="" target="_blank">业务介绍</a></p>
            <div class="business_cont">
            <p class="title">家庭宽带（业务介绍）</p>
            <img src="/home/images/line.jpg" width="100%"/>
                <p>采用光纤到楼栋配合同轴电缆/网线入户的100M接入和直接1000M光纤入户的方式，为用户提供高速、稳定的宽带网接入和各项家庭互联网信息服务。</p>
            </div>
