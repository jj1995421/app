...
<!--                                  <li><a href="#">使用指南</a></li>
    ...
    <div class="wrapper_boxrig" style="margin-left:1%;">
            <p class="tit"><a href="" target="_blank">首页</a> 》 <a href="" target="_blank">轮播影院</a> 》 <a href="" target="_blank">使用指南</a></p>
            <div class="business_cont">
            <p class="title">轮播影院（使用指南）</p>
            <img src="/home/images/line.jpg" width="100%"/>
                <p>订购了准视频点播业务的有线电视用户，请用遥控器按以下示意图操作：</p>
                <p>第一步，打开电视机、机顶盒，电视屏幕出现首页菜单，用遥控器上下键选择“本地生活”，按“确认”键进入。</p>
                <p>第二步，按遥控器左右键选中“轮播影视”，按“确认”键进入。</p>
                <p>第三步：按遥控器上下左右键，选中您想看节目类型及影片名称：按“确认”键进入观看</p>
                <p>快捷功能：按摇控器上的“影院”键，可快速进入“标清轮播”进行选择</p>
            </div>
        </div>
    </div>
</div>
