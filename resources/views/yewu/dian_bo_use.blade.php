...
<!--                                  <li><a href="#">使用指南</a></li>
        ...
        <div class="wrapper_boxrig" style="margin-left:1%;">
            <p class="tit"><a href="" target="_blank">首页</a> 》 <a href="" target="_blank">影视点播</a> 》 <a href="" target="_blank">使用指南</a></p>
            <div class="business_cont">
             <p class="title">影视点播（使用指南）</p>
            <img src="/home/images/line.jpg" width="100%"/>
                <p>订购了互动业务套餐的有线电视用户，请用遥控器按以下示意图操作</p>
                <p>第一步，打开电视机、机顶盒，电视屏幕出现首页菜单，用遥控器上下键选择“高清点播”，按“确认”键进入。</p>
                <p>第二步，屏幕下方栏目中，按遥控器左右键选中“点播”，按“确认”键进入。</p>
                <p>第三步：按遥控器上下左右键，选中您想看节目类型：电视剧、电影、少儿、娱乐、生活、财经等等，按“确认”键进入。</p>
                <p>第四步：搜索功能：按页面提示，使用摇控器输入所要查寻的节目的首拼子母，可现实节目搜索。</p>
            </div>
