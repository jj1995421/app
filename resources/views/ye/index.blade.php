...
<div class="mws-panel grid_8">
  ...
  <div class="mws-panel-body no-padding">
    ...
    <form action="/admin/ye/index" method="get">
      ...
      <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
        <thead>
          <tr role="row">
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 260px;">所属分类ID</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 187px;">发表时间</th>
        ...
        @foreach($articles as $k=>$v)
          ...
          ">
            ...
            <td class=" ">{{$v['title']}}</td>
            <td class=" ">{{$v['ycate_id']}}</td>
            <td class=" ">{{$v['created_at']}}</td>
            <td class=" ">&nbsp;&nbsp;&nbsp;<a href="/admin/ye/edit/{{$v['id']}}"  style="color:black;font-size:16px;"><i class="icon-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             <a href="/admin/ye/delete/{{$v['id']}}" style="color:black;font-size:16px;"><i class="icon-remove"></i></a></td>
          </tr>
          @endforeach
        </tbody>
      </table>
