      ...
      <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
        ...
        @foreach($cates as $k=>$v)
          ...
          <!-- 这里分配变量到模板 -->
            ...
            <td class=" ">&nbsp;&nbsp;&nbsp;
            <a href="/admin/cate/add/{{$v['id']}}"  style="color:black;font-size:16px;"><i class="icon-plus"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="/admin/cate/edit/{{$v['id']}}"  style="color:black;font-size:16px;"><i class="icon-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="/admin/cate/delete/{{$v['id']}}" style="color:black;font-size:16px;"><i class="icon-remove"></i></a></td>
          </tr>
          @endforeach
        </tbody>
      </table>
