...
<title>南昌广电网络</title>
<link rel="stylesheet" type="text/css" href="/home/detail/css/reset.css" />
<link href="/home/detail/css/bootstrap.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="/home/detail/css/index.css" />
<link rel="stylesheet" type="text/css" href="/home/detail/css/main.css" />
<script type="text/javascript" src="/home/detail/js/jquery-1.8.3.min.js"></script>
<script type="text/javascript" src="/home/detail/js/jquery.SuperSlide.js"></script>
<!--分页-->
<script src="/home/detail/js/bootstrap.js" type="text/javascript"></script>
<script src="/home/detail/js/jquery.twbsPagination.js" type="text/javascript"></script>
<script src="/home/detail/js/zzsc.js" type="text/javascript"></script>
</head>

<body>
<!--头部-->
<div class="top">
	<img src="/home/detail/images/top.jpg" />
</div>
<!--头部 end-->
<!--导航部分-->
<div class="nav">
    ...
    <!--左侧-->
    	<div class="wrapper_boxleft">
            ...
            <div class="news_r_box" style="border-bottom:none;">
                    <img src="/home/detail/images/newsr1.jpg" />
                </div>
                <div class="news_r_box">
                    <img src="/home/detail/images/newsr2.jpg" />
                </div>
        </div>
        <!--右侧列表-->
        <div class="wrapper_boxrig">
            ...
            <div class="bussiness">
            	<!--广播-->
            	<img src="/home/detail/images/guangbo.jpg" />
                <img src="/home/detail/images/gaoqing.jpg"  style="margin-top:5px;"/>
                <div class="gaoqing">
                	<div class="gaoqing_profile">
                          采用光纤到楼栋配合同轴电缆/网线入户的100M接入和直接1000M光纤入户的方式，为用户提供高速、稳定的宽带网接入和各项家庭互联网信息服务。
                    </div>
...
<p class="channel_de"><span><a href="" target="_blank">业务介绍</a></span><span><a href="" target="_blank">使用指南</a></span><span><a href="" target="_blank">业务办理</a></span></p>                    </div>
                ...
                <!--宽带-->
                <img src="/home/detail/images/kuandai.jpg" style="margin-top:5px;" />
                <img src="/home/detail/images/kuandaibanner.jpg" />
                <div class="gaoqing">
                	<div class="gaoqing_profile">
                          采用光纤到楼栋配合同轴电缆/网线入户的100M接入和直接1000M光纤入户的方式，为用户提供高速、稳定的宽带网接入和各项家庭互联网信息服务。
                    </div>
